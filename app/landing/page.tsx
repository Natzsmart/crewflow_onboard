...
const PLANS = [
  ...
  { name:"Professional", price:"$49",   period:"/month", highlight:true,  features:["Unlimited seafarers","Everything in Starter","Telegram + WhatsApp alerts","n8n automation workflows","AI candidate matching","Priority support"], cta:"Start Free Trial" },
